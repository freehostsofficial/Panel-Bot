const { SlashBuilder, SlashCommandBuilder, EmbedBuilder } = require('discord.js');
...
module.exports = {
    ...
    async execute(client, interaction) {
        ...
        if (!url.startsWith('http')) return interaction.editReply("❌ Endpoint URI must utilize the `http://` or `https://` protocol.");
